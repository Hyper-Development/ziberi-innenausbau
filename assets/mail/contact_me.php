...
$empfaenger = "emmentalerniclas@gmail.com"; //Empfänger-Adresse
$mail_cc = "aganramadani0@gmail.com"; //CC-Adresse, diese E-Mail-Adresse bekommt einer weitere Kopie
$betreff = "Kontaktanfrage"; //Betreff der Email
 
$url_ok = "../../index.html"; //Zielseite, wenn E-Mail erfolgreich versendet wurde
$url_fehler = "../../index.html"; //Zielseite, wenn E-Mail nicht gesendet werden konnte
